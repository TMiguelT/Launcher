...
public class JavaStatusTest {
    ...
    @Test
    public void test_oldSystemNewLocal() {
        assertTrue(JavaStatus.getStatus(
                "1.8.0_121", //We should succeed if our system Java is an old 1.8
                "1.8.0_131", //we need a new 1.8, and
                "1.8.0_131" //we have that exact version locally
        ) == JavaStatus.LocalCompatible);
    }
